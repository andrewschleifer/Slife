...
- (void)kfSetupResizeCursors
{
    ...
    if (kfIsVerticalResizeCursor == nil)
    {
        ...
        NSLog(@"Slife: No horizontal resizing cursor located.  Please report this as a bug.");
    }
    if (kfNotIsVerticalResizeCursor == nil)
    {
        kfNotIsVerticalResizeCursor = [[NSCursor arrowCursor] retain];
        NSLog(@"Slife: No vertical resizing cursor located.  Please report this as a bug.");
    }
}
